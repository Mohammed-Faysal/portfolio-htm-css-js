...
// ScrollReveal().reveal('.svg-container, .Designing-skills, .Graphics, .websiteImageBox:nth-child(3), .websiteImageBox:nth-child(6), .formSection, .cardSec .card:nth-child(3)', {origin: 'right'});
